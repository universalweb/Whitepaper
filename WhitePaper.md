...
#####  ABSTRACT
Sentivate is a revolutionary advancement, not evolutionary, in Internet architecture. Sentivate has a hybrid topology consisting of interconnected centralized & decentralized systems. The network is designed to go beyond the capabilities that any solely centralized or decentralized network could offer. It's hybrid topology and data transport protocol ensures Sentivate can leverage all capabilities. Sentivate has the ability to operate in a decentralized or centralized topology, if the need ever arose, giving it a unique dynamic topology. Sentivate is designed to be a realistic and viable replacement for the increasingly slugish Internet we have today.
