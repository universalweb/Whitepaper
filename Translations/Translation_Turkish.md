...
###### BANDWIDTH KRİZİ
[Bant genişliği sınırlıdır, ihtiyaçlarımız ağlarımızı büyütmek için dışarıdadır.](https://www.scientificamerican.com/article/the-bandwidth-bottleneck-that-is-throttling-the-internet/) Bu sorunu çözmek için mevcut bileşenlerin yerini alacak modern devrimci teknolojiye ihtiyacımız var. Bunu yapmazsak, hızlı şerit ve verilerin önceliklendirilmesi tek seçeneğimizdir. İnsanların Net Tarafsızlığı yürürlükten kaldırmasının korkusu, interneti eğirmek için tek umudumuz olacak. IoT'nin kaçınılmaz yükselişi, kişi başına daha fazla cihaz, ev başına daha fazla cihaz, kendi kendine sürüş araba, araba sigortası analitiği ve çevrimiçi gelişmekte olan ülkeler, sahip olmadığımız bant genişliğini emiyor.

###### GÜNCEL WEB KENDİNİ YIYOR
HTTP ve DNS uzun zaman önce, modern talepler göz önünde bulundurulmaksızın inşa edildi. Giderek daha fazla bant genişliği emiliyor, HTTP, uzun ölçeklenebilirlik sorunlarını göstermeye devam ediyor ve DNS güvenilir veya ölçeklenebilir değil. Eğer web'in yarısı DoS-ing'e özgü DNS sunucularından kapatılabiliyorsa, bariz bir mimari problem var. HTTP para için mevcut araç. Tüm dijital ekonomi HTTP üzerinden taşınır. HTTP veya DNS’e yavaşlama, çok daha yavaş bir küresel ekonomi demektir. DNS ve HTTP doğal olarak bozuluyor, ölçeklenebilirliği zayıf, korkunç derecede yavaş, modern özelliklerden yoksun, bant genişliğini yiyor ve tüketicilere ve işletmelere milyarlarca mal oluyor. Bu sorunu çözemezsek, ekonomiye büyük bir darbe yaşayacağız. Tüm dolar işaretlerini hesaba kattığınızda, kısa bir süre sonra yavaş bir ağın küresel bir insani kriz olduğu anlaşılıyor.

1.  [_1.Bir saniyelik gecikme Amazon 1.6BB'de satislara mal olabilir.](https://www.fastcompany.com/1825005/how-one-second-could-cost-amazon-16-billion-sales_)
2.  [_2.	“10 yil önce Amazon, her 100ms'lik gecikmenin satislarda% 1'e mal oldugunu buldu”_](https://www.gigaspaces.com/blog/amazon-found-every-100ms-of-latency-cost-them-1-in-sales/)
3.  [_“10 yil sonra hizli ileriye dogru bir 2017 Akamai çalismasi, web sitesinin yüklenme süresindeki her 100 milisaniyede bir gecikmenin dönüsüm oranlarini% 7 oraninda azaltabilecegini - bu da satislarda önemli bir düsüs oldugunu - Amazon'un ilk konusmasindan itibaren% 6 saniye ve milisaniye cinsinden gecikme hakkinda. Bu, kullanici deneyimi e-ticaret basarisi için kritik hale geldiginden, çevrimiçi perakendeciler için islerin daha kolay olmadigini gösteriyor. 
